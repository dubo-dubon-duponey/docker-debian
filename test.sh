...
if [ ! "$TEST_DOES_NOT_BUILD" ]; then
  ...
  if [ "$s" != "99ef315c3c0a8f9c713dc97ccc61cf820dfe4dcfe2d8958829c3d3033c91674d4e2008d891fa76a8f26c295339c7bd3a4e988ed34ee187e2aac0cae29a4bb3ba  /rootfs/linux/amd64/debootstrap.tar" ]; then
  ...
  s="$(head -n 1 context/debian/rootfs/buster-2020-01-01.sha)"
  if [ "$s" != "99ef315c3c0a8f9c713dc97ccc61cf820dfe4dcfe2d8958829c3d3033c91674d4e2008d891fa76a8f26c295339c7bd3a4e988ed34ee187e2aac0cae29a4bb3ba  /rootfs/linux/amd64/debootstrap.tar" ]; then
